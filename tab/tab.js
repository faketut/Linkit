...
// Function to delete skills (legacy function for backward compatibility)
async function deleteSkills() {
  return await deleteAllSkills();
}

// Function to check if we're on skills page and start deletion
...
}), // Check for skills page and trigger deletion
checkAndDeleteSkills(), // Set page type for skills page
window.location.href.includes('/details/skills/') && io(de.Skills), await cb(), Nb(), Lb()))();
